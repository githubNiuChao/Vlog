...
-(ZYTextField *)tf{
    if (!_tf) {
        ...
        _tf.backgroundColor = KHEXCOLOR(0xFFFFFF);
...
//        kViewRadius(_tf, 2);
        kViewBorderRadius(_tf, 2, 0.05, kBuleColor)
...
-(UIButton *)cancelBtn{
    if (!_cancelBtn) {
        ...
        [_cancelBtn setTitleColor:KHEXCOLOR(0x0F81FE) forState:UIControlStateNormal];
        [self addSubview:_cancelBtn];
        _cancelBtn.frame = CGRectMake(kSCREEN_WIDTH - 10,
                                      10,
                                      0,
                                      0);
