...
-(JobsSearchBar *)jobsSearchBar{
    if (!_jobsSearchBar) {
        ...
        _jobsSearchBar.mj_size = CGSizeMake(kSCREEN_WIDTH, 60);
        @weakify(self)
            ...
            if ([data isKindOfClass:NSString.class]) {
                ...
                if ([str isEqualToString:@"textFieldShouldEndEditing:"]) {//正常位
                    ...
                    [UIView animateWithDuration:1
                        ...
                        self->_jobsSearchBar.cancelBtn.frame = CGRectMake(kSCREEN_WIDTH - 10,
                                                                          10,
                                                                          0,
                                                                          0);
                    } completion:^(BOOL finished) {
                    ...
                    [UIView animateWithDuration:1
                        ...
                        self->_jobsSearchBar.tf.frame = CGRectMake(10,
                                                                   10,
                                                                   kSCREEN_WIDTH - 20 - 80 - 10,
                                                                   self->_jobsSearchBar.mj_h - 20);
                        
                        self->_jobsSearchBar.cancelBtn.frame = CGRectMake(kSCREEN_WIDTH - 80 - 10,
                                                                          10,
                                                                          80,
                                                                          self->_jobsSearchBar.mj_h - 20);
                    } completion:^(BOOL finished) {
