...
{
    if (_tableView == nil) {
//        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen jk_width], SCREEN_HEIGHT - kTopHeight -kTabBarHeight) style:UITableViewStylePlain];
...
//        _tableView.mj_footer.ignoredScrollViewContentInsetBottom = 30;
        ...
        _tableView.backgroundColor=[UIColor jk_colorWithHexString:@"f2f2f2"];
...
////#endif
//
//        _collectionView.backgroundColor=[UIColor jk_colorWithHexString:@"f2f2f2"];
