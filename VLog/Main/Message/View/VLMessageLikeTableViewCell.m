...
@interface VLMessageLikeTableViewCell ()
...
@implementation VLMessageLikeTableViewCell
...
- (UIImageView *)rightImageView{
    if (!_rightImageView) {
        ...
        kViewRadius(_rightImageView, 5);
        _rightImageView.image = kNameImage(@"5.jpg");
    }
