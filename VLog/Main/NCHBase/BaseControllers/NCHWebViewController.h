...
@class NCHWebViewController;
@protocol NCHWebViewControllerDelegate <NSObject>
...
@protocol NCHWebViewControllerDataSource <NSObject>
...
@interface NCHWebViewController : NCHBaseViewController<WKNavigationDelegate, WKUIDelegate, NCHWebViewControllerDelegate, NCHWebViewControllerDataSource>
