...
@interface NCHSettingCell ()

@end

@implementation NCHSettingCell

static NSString *const ID = @"NCHSettingCell";
+ (instancetype)cellWithTableView:(UITableView *)tableView andCellStyle:(UITableViewCellStyle)style
{
    NCHSettingCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if(cell == nil)
    {
...
- (void)changeUI
{
    ...
    if ([self.item isKindOfClass:[NCHWordArrowItem class]]) {
