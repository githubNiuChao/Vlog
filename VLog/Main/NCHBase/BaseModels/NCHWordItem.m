...
- (CGFloat)cellHeight {
    if (!_cellHeight) {
        ...
        _cellHeight += [totalString boundingRectWithSize:CGSizeMake(Main_Screen_Width - 20, MAXFLOAT) options:0 attributes:@{NSFontAttributeName : self.subTitleFont} context:nil].size.height;
